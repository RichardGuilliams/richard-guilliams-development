    ...
    <div className="section section__extra-margin skills">
      ...
      <ul className={`skill-container`}>
        <li className={`card card-skill slide-right ${animatedClass}`}>
          <div>
            <Image alt='Nodejs' width={200} height={200} src={`/img/nodejs.png`}/>
        ...
        <li className={`card card-skill slide-left ${animatedClass}`}>
          <div>
            <Image alt='HTML, CSS and JS' width={200} height={200} src={`/img/html-css-js.png`}/>
        ...
        <li className={`card card-skill slide-right ${animatedClass}`}>
          <div>
            <Image  alt='MongoDB' width={200} height={200} src={`/img/mongodb.png`}/>
        ...
        <li className={`card card-skill slide-left ${animatedClass}`}>
          <div>
            <Image  alt='React' width={200} height={200} src={`/img/react.png`}/>
        ...
        <li className={`card card-skill slide-right ${animatedClass}`}>
          <div>
            <Image alt='Postman' width={200} height={200} src={`/img/postman.png`}/>
        ...
        <li className={`card card-skill slide-right ${animatedClass}`}>
          <div>
            <Image alt='Express' width={200} height={200} src={`/img/express.png`}/>
